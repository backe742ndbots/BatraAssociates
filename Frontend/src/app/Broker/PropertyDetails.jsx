      ...
      <div className="max-w-7xl mx-auto px-4 py-1 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <GlassCard title="Property Overview">
              <Grid>
                {property.pricing?.askingRaw && (
                  <Detail
                    label="Price"
                    value={property.pricing.askingRaw}
                  />
                )}

                {property.customFields?.SIZE && (
                  <Detail
                    label="Size"
                    value={`${property.customFields.SIZE} sq ft`}
                  />
                )}

                {property.bhk && <Detail label="BHK" value={property.bhk} />}
                ...
                {property.balconies && <Detail label="Balconies" value={property.balconies} />}
                ...
                {property.facing && <Detail label="Facing" value={property.facing} />}
                {property.furnishing && <Detail label="Furnishing" value={property.furnishing} />}
              </Grid>
            </GlassCard>
            ...
            {property.customFields &&
              Object.keys(property.customFields).length > 0 && (
                <GlassCard title="Newly Added Data">
            ...
            {mapImage && (
              <GlassCard title="Location Map">
                <img src={mapImage} className="w-full rounded-xl border" />
              </GlassCard>
            )}
          </div>
